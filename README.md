...
Here is the complete, unified markdown for your `README.md` file, featuring your exact GitHub username and the cleanly formatted installation code blocks.

Just copy everything below the line directly into your file:

---

# 🤖 Groq & Roll Data Laundromat: LLM-Powered Spreadsheet Washer

An enterprise-grade, high-performance Streamlit web application that utilizes advanced Large Language Models (LLMs) to automatically ingest, clean, analyze, and query large datasets.
